...
app.config['MONGO_URI'] = 'mongodb://localhost:27017/credit_card_database'

# Initialize PyMongo
mongo = PyMongo(app)
Collection_1 = mongo.db.Data_frame
...
def predict():
    ...
    result = "The credit card holder will be Defaulter in the next month" if prediction == 1 else "The Credit card holder will not be Defaulter in the next month"
